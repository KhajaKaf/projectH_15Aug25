  ...
  const contactInfo = [
    {
      ...
      action: `https://maps.google.com/?q=${encodeURIComponent(restaurantInfo.address)}`
    },
    {
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1920&h=600&fit=crop')] bg-cover bg-center opacity-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-slate-400 text-lg leading-relaxed">
                ...
                or need assistance with your order, we're here to help.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <Card key={index} className="bg-slate-800/80 border-slate-700 hover:border-amber-500/30 transition-all duration-300 group">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        {info.action && (
                          ...
                          >
                            {info.title === "Address" ? "View on Maps" : `${info.title === "Phone" ? "Call" : "Email"} Now`}
                          </a>
                        )}
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                   ...
                   {/*  <div className="flex justify-between items-center">
                      ...
                      <span className="text-amber-400 font-medium">{restaurantInfo.hours.friday}</span>
                    </div> */}
                    {/* <div className="flex justify-between items-center">
            ...
            {/* Social Media */}
            <div>
              <h3 className="text-xl font-semibold text-slate-100 mb-4">Follow Us</h3>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className={`w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 transition-all duration-300 hover:bg-slate-700 transform hover:scale-110 ${social.color}`}
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div>
            <Card className="bg-slate-800/80 border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-100 text-2xl">Send us a Message</CardTitle>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-slate-100 mb-8 text-center">Find Us</h2>
          <Card className="bg-slate-800/80 border-slate-700 overflow-hidden">
            <div className="aspect-video bg-slate-700 flex items-center justify-center">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-slate-100 mb-2">Interactive Map</h3>
                <p className="text-slate-400 mb-4">Google Maps integration will be added here</p>
